  ...
  import { createXMLHttRequest } from './utils/createXMLHttpRequest.js'
    // let arrTasks = [
    //     {
    //         name: "task 1",
    //         completed: true,
    ...
    createXMLHttRequest("GET", "http://localhost:3000/tasks?userId=1", taskInit)

    function taskInit(arrTasks){
